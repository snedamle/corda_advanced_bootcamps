...
public class ImplicitMigrateToSignatureConstraintFlow extends FlowLogic<SignedTransaction> {
    ...
    public SignedTransaction call() throws FlowException {
        ...
        StateAndRef<OldState> input = getServiceHub().getVaultService().queryBy(OldState.class).getStates().get(0);
        ...
        transactionBuilder.addCommand(new OldContract.Commands.Issue() , ImmutableList.of(getOurIdentity().getOwningKey() , counterParty.getOwningKey()));
